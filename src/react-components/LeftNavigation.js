...
const LeftNavigation = () => {
  ...
  return (
    ...
    <ul className='border-b-2 mt-2 ml-2 pb-4'>
      <li className='h-8 flex items-end'> <img src={nav_icons_urls.home_icon_url} alt="Goto Youtube Home" className='w-5 h-5 mt-3 ml-2' /> <button className='self-end ml-2 text-l'>Home</button> </li>
      <li className='h-8 flex items-end'> <img src={nav_icons_urls.shorts_icon_url} className='w-5 h-5 mt-3 ml-2'/> <button className='self-end ml-2 text-l'>Shorts</button> </li>
      <li className='h-8 flex items-end'> <img src={nav_icons_urls.subscriotion_icon_url} className='w-5 h-5 mt-3 ml-2'/> <button className='self-end ml-2 text-l'>Subscription</button> </li>
    </ul>
    <ul className='border-b-2 mt-2 ml-2 pb-4 text-left'> <span className=''>You {">"}</span> 
    ...
    <ul className='border-b-2 mt-2 ml-2 pb-4 text-left'> <span className=''>Subscriptions</span> 
    ...
    <ul className='border-b-2 mt-2 ml-2 pb-4 text-left'> <span className=''>Explore</span> 
    ...
    <ul className='border-b-2 mt-2 ml-2 pb-4 text-left'> <span className=''>More+</span> 
